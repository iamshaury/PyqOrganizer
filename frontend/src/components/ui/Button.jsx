...
const Button = ({ 
  ...
  const variants = {
    ...
    secondary: 'bg-gray-700 text-gray-200 border border-gray-600 hover:bg-gray-600 focus:ring-purple-500 shadow-lg',
    ghost: 'text-gray-300 hover:text-white hover:bg-gray-700/50 focus:ring-purple-500',
